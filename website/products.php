<head>
  ...
  ?>
		<script src="productHandler.js"></script>
      <?php 
		
		$productsInPossession = array();
		if (isset($_SESSION['toResetProducts']) and $_SESSION['toResetProducts'] == true){
			Commands::unsetSessionProducts();
			markForProductsReset(false);
		}else
